...
| #04 | En tant que développeur, je souhaite pouvoir modifier une **User story** (description, type, importance, plannification, état) si elle est non associée à un sprint ou non associée au sprint actuel afin de la mettre à jour. (Undo-able)  | Haute | 3 | Sprint 1 |
...
| #37 | En tant qu'utilisateur, je souhaite pouvoir modifier mes informations personnelles telles que mon prénom, nom et ajouter une photo de profil afin de mettre à jour mes informations. | Basse | 1 | Sprint 3 |
